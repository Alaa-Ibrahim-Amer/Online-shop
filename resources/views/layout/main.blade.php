...
<html lang="en">
  ...
  <body>
      ...
      <div class="row bg-secondary py-1 px-xl-5">
        <div class="col-lg-6 d-none d-lg-block">
          <div class="d-inline-flex align-items-center h-100">
            <a class="text-body mr-3" href="{{url('')}}">About</a>
            <a class="text-body mr-3" href="{{url('')}}">Contact</a>
            <a class="text-body mr-3" href="{{url('')}}">Help</a>
            <a class="text-body mr-3" href="{{url('')}}">FAQs</a>
          </div>
        </div>
        <div class="col-lg-6 text-center text-lg-right">
          ...
          <div class="d-inline-flex align-items-center d-block d-lg-none">
            <a href="{{url('')}}" class="btn px-0 ml-2')}}">
          ...
          >
            <div class="navbar-nav w-100">
              <div class="nav-item dropdown dropright">
                ...
                >
                  <a href="{{url('')}}" class="dropdown-item">Men's Dresses</a>
                  <a href="{{url('')}}" class="dropdown-item">Women's Dresses</a>
                  <a href="{{url('')}}" class="dropdown-item">Baby's Dresses</a>
                </div>
              </div>
              <a href="{{url('')}}" class="nav-item nav-link">Shirts</a>
              <a href="{{url('')}}" class="nav-item nav-link">Jeans</a>
              <a href="{{url('')}}" class="nav-item nav-link">Swimwear</a>
              <a href="{{url('')}}" class="nav-item nav-link">Sleepwear</a>
              <a href="{{url('')}}" class="nav-item nav-link">Sportswear</a>
              <a href="{{url('')}}" class="nav-item nav-link">Jumpsuits</a>
              <a href="{{url('')}}" class="nav-item nav-link">Blazers</a>
              <a href="{{url('')}}" class="nav-item nav-link">Jackets</a>
              <a href="{{url('')}}" class="nav-item nav-link">Shoes</a>
            </div>
          </nav>
        </div>
        <div class="col-lg-9">
          ...
          >
            ...
            >
              <div class="navbar-nav mr-auto py-0">
                <a href="{{url('index.html')}}" class="nav-item nav-link active">Home</a>
                <a href="{{url('shop.html')}}" class="nav-item nav-link">Shop</a>
                <a href="{{url('detail.html')}}" class="nav-item nav-link">Shop Detail</a>
                <div class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                    <a href="{{url('cart.html')}}" class="dropdown-item">Shopping Cart</a>
                    <a href="{{url('checkout.html')}}" class="dropdown-item">Checkout</a>
                  </div>
                </div>
                <a href="{{url('contact.html')}}" class="nav-item nav-link">Contact</a>
              </div>
              <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                <a href="{{url('')}}" class="btn px-0">
                ...
                <a href="{{url('')}}" class="btn px-0 ml-3">
        ...
        <div class="col-lg-8 col-md-12">
          <div class="row">
            ...
            <div class="col-md-4 mb-5">
              ...
              <div class="d-flex">
                <a class="btn btn-primary btn-square mr-2" href="{{url('#')}}"
                ...
                ></a>
                <a class="btn btn-primary btn-square" href="{{url('#')}}"
      ...
      >
        <div class="col-md-6 px-xl-0">
          <p class="mb-md-0 text-center text-md-left text-secondary">
            &copy; <a class="text-primary" href="{{url('#')}}">Domain</a>. All Rights
    ...
    <!-- Back to Top -->
    <a href="{{url('#')}}" class="btn btn-primary back-to-top"
